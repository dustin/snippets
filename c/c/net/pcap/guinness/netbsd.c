...
#define path_unix NULL
#define path_kmem NULL
#define syslog_flag 0

#define ERROR(a) fprintf(stderr, a); fflush(stderr);
#define ERROR1(a,b) fprintf(stderr, a, b); fflush(stderr);
#define ERROR2(a,b,c) fprintf(stderr, a, b, c); fflush(stderr);
